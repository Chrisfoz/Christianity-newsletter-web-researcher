...
def prepare_content_for_gpt(serialized_results):
    content = "Create a markdown article about the following LLM news, using the relevant URLs as citations where necessary:\n\n"
...
def main():
    ...
    schedule_choice = input(colored("Do you want to schedule recurring execution? (yes/no): ", "cyan")).lower()
