...
def schedule_and_run(schedule_choice, interval, exa_client, openai_api_key, query, num_results, target_languages):
...
def main():
    ...
    if schedule_choice == 'custom':
        ...
        schedule_and_run(schedule_choice, interval, exa_client, openai_api_key, query, num_results, target_languages)
    elif schedule_choice == 'weekly':
        schedule_and_run(schedule_choice, 168, exa_client, openai_api_key, query, num_results, target_languages)
    else:
