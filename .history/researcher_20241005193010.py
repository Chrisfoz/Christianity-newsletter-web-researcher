...
def prepare_html_template(language, encoded_logo, author_name):
    ...
    <body class="font-sans">
        ...
        <div class="container mx-auto px-4 py-8 max-w-4xl">
            <h1 class="text-4xl font-bold mb-2 text-white">AI Risk: Aligning Technology with Safety and Innovation</h1>
            <p class="text-xl text-gray-400 mb-4">Exploring the Challenges and Opportunities in Contemporary AI Systems</p>
