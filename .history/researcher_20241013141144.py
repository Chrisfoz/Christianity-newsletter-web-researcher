...
def prepare_content_for_gpt(serialized_results):
    content = "Create a markdown article about world Christianity news from the last 14 days, focusing on mainstream Christianity, using the relevant URLs as citations where necessary:\n\n"
...
def prepare_html_template(language, encoded_logo, author_name):
    return f"""
    <!DOCTYPE html>
...
def generate_html(markdown_content, language, logo_path, author_name):
    ...
    html_template = prepare_html_template(language, encoded_logo, author_name)
...
def main():
    ...
    logo_path = "C:\\Users\\User\\OneDrive\\Documents\\GitHub\\web-researcher-with scheduler\\AIforthesoul.png"
