...
def prepare_content_for_gpt(serialized_results):
    content = "Create a markdown article about world Christianity news from the last 14 days, focusing on mainstream Christianity, using the relevant URLs as citations where necessary. All stories should come from different URLs and publications so we get a wide range of soruces - examples include reputable news outlets and Chrisitian news providers:\n\n"
...
def prepare_html_template(language, logo_path, author_name):
    ...
    <body class="font-sans">
        ...
        <div class="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <p class="text-lg font-semibold mb-2 text-gray-300">By {author_name}</p>
            <p class="text-md text-gray-400 mb-8">Date: {current_date} | This newsletter was created using AI - email support@aiforthesoul.org for more information</p>
